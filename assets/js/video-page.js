$(function whenDomIsReady() {
  ...
  setTimeout(function afterRetrievingVideos() {
    ...
    const videosHtml = _.reduce(videos, (html, video) => {
      html += `<li class="video">  <h2>${video.title}</h2>  <iframe width="640" height="390" src="${video.src}" frameborder="0" allowfullscreen></iframe></li>`;
      return html;
    }, '');
